...
config = {
    ...
    # 四指 - 近端 (Proximal)
    "index_proximal": {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 30, "w_margin_ratio": 0.05, "l_margin_top": 0.10, "l_margin_bottom": 0.4, "f_ratio": 0.15},
    "middle_proximal":{"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 30, "w_margin_ratio": 0.05, "l_margin_top": 0.10, "l_margin_bottom": 0.4, "f_ratio": 0.15},
    "ring_proximal":  {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 30, "w_margin_ratio": 0.05, "l_margin_top": 0.10, "l_margin_bottom": 0.4, "f_ratio": 0.15},
    "pinky_proximal": {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 30, "w_margin_ratio": 0.05, "l_margin_top": 0.10, "l_margin_bottom": 0.4, "f_ratio": 0.15},

    # 四指 - 中端 (Middle) - L20新增
    "index_middle":  {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 20, "w_margin_ratio": 0.05, "l_margin_top": 0.05, "l_margin_bottom": 0.1, "f_ratio": 0.15},
    "middle_middle": {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 20, "w_margin_ratio": 0.05, "l_margin_top": 0.05, "l_margin_bottom": 0.1, "f_ratio": 0.15},
    "ring_middle":   {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 20, "w_margin_ratio": 0.05, "l_margin_top": 0.05, "l_margin_bottom": 0.1, "f_ratio": 0.15},
    "pinky_middle":  {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 20, "w_margin_ratio": 0.05, "l_margin_top": 0.05, "l_margin_bottom": 0.1, "f_ratio": 0.15},

    # 四指 - 远端 (Distal)
    "index_distal":   {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 30, "w_margin_ratio": 0.05, "l_margin_top": 0.05, "l_margin_bottom": 0.4, "f_ratio": 0.6},
    "middle_distal":  {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 30, "w_margin_ratio": 0.05, "l_margin_top": 0.05, "l_margin_bottom": 0.4, "f_ratio": 0.6},
    "ring_distal":    {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 30, "w_margin_ratio": 0.05, "l_margin_top": 0.05, "l_margin_bottom": 0.4, "f_ratio": 0.6},
    "pinky_distal":   {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 30, "w_margin_ratio": 0.05, "l_margin_top": 0.05, "l_margin_bottom": 0.4, "f_ratio": 0.6},

    # 👑 大拇指曲面包络模式 (已加入 L20 的 proximal 环节)
    "thumb_metacarpals": {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 30, "w_margin_ratio": 0.05, "l_margin_top": 0.3, "l_margin_bottom": 0.3, "f_ratio": 0.45},
    "thumb_proximal":    {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 20, "w_margin_ratio": 0.05, "l_margin_top": 0.2, "l_margin_bottom": 0.35, "f_ratio": 0.45},
    "thumb_distal":      {"face_axis": 0, "face_dir": 1, "width_axis": 1, "length_axis": 2, "target_num": 50, "w_margin_ratio": 0.02, "l_margin_top": 0.00, "l_margin_bottom": 0.40, "f_ratio": 0.45},
}
# ===================================================================
